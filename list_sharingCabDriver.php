                ...
                <table class="min-w-full text-left border-separate border-spacing-y-2">
                    ...
                    <tbody class="text-sm">
                        ...
                        <tr class="bg-white dark:bg-gray-900 rounded-lg shadow-sm">
                            ...
                            <td class="p-3 text-gray-700 dark:text-gray-300">Khan</td>
                          ...
                          <tr class="bg-white dark:bg-gray-900 rounded-lg shadow-sm">
                            ...
                            <td class="p-3 text-gray-700 dark:text-gray-300">Deol</td>
                          ...
                          <tr class="bg-white dark:bg-gray-900 rounded-lg shadow-sm">
                            ...
                            <td class="p-3 text-gray-700 dark:text-gray-300">Devgan</td>
